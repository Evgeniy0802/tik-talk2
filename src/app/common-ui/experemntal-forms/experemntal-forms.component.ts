...
import { FormsService } from '../../data/services/forms.service'
import { Feature, OperationOption } from '../../data/interfaces/forms.interface'
...
export class ExperemntalFormsComponent {
	...
	operations: OperationOption[] = [
		{ value: Operation.acceptance, label: 'Приёмка' },
		{ value: Operation.assembly, label: 'Сборка' },
		{ value: Operation.shipment, label: 'Отгрузка' },
		{ value: Operation.layout, label: 'Раскладка' },
		{ value: Operation.roll, label: 'Перекат' },
		{ value: Operation.hourly, label: 'Часовой' },
		{ value: Operation.inventory, label: 'Инвентаризация' },
		{ value: Operation.repackaging, label: 'Переупаковка' },
		{ value: Operation.sorting, label: 'Сортировка' }
	]
